    ...
    <div className=" flex min-h-screen flex-col items-center py-10 md:px-36 px-5 pb-20 space-y-10">
      ...
      <div className="w-full flex flex-col md:flex-row gap-5">
        <div className="md:w-1/4 w-full">
          <UserCard
            name="ETHPEROR"
            address="1ExAmpLe0FaBiT...sSV5tsGaMF6hd"
            path={ghost1}
            facebook="#"
            discord="#"
            mail="#"
        ...
        <div className="md:w-3/4 w-full ">
          <div className="w-full space-x-2 flex md:space-x-8 uppercase text-sm py-3 md:px-5 font-black  md:text-md">
            <p
              className={activeContent === "art" ? "text-[#4B54A1]" : "hover:text-body-text"}
              onClick={() => setActiveContent("art")}
            >
              my art
            </p>
            <p
              className={
                activeContent === "collectables" ? "text-[#4B54A1]" : "hover:text-body-text"
              }
              onClick={() => setActiveContent("collectables")}
            >
              collectables
            </p>
            <p
              className={activeContent === "media" ? "text-[#4B54A1]" : "hover:text-body-text"}
              onClick={() => setActiveContent("media")}
            >
              media
            </p>
            <p
              className={activeContent === "history" ? "text-[#4B54A1]" : "hover:text-body-text"}
