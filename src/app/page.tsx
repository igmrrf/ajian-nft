  ...
  return (
    <div className=" flex min-h-screen flex-col items-center py-10 md:px-36 px-5 space-y-10">
      ...
      <div className="w-full">
        <h3 className="text-nav-text text-xl md:text-3xl text-left font-extrabold">
          {" "}
          NFTS RECENTLY PRINTED{" "}
        </h3>
      </div>
      ...
      <div className="flex flex-wrap gap-2">
        <TipsCard
          name="Secure"
          details="Less than a week, you will recieve your print of your NFT at home."
          path={well}
        />
        <TipsCard name="Trusted" details="hello world i am writing" path={well} />
        <TipsCard
          name="wow"
          details="We Ship To Every Country In The World For A Flat Fee"
          path={well}
        />
      </div>

      <div className="w-full flex justify-between items-center">
        <h3 className="text-nav-text md:text-3xl text-md w-2/3  font-extrabold block">
          {" "}
          GET YOUR OWN NFT PRINTED{" "}
        </h3>
        <p className="items-center">
          {" "}
          SEE ALL <BsArrowRight className="inline-block" />{" "}
        </p>
      </div>
      ...
      <div className=" border-4 border-black flex flex-col ">
        <div className="md:px-24 px-10 py-6 space-y-10">
          {" "}
          <h4 className="text-nav-text text-4xl md:text-6xl font-black">
            {" "}
            Refer a friend, get 10% off
          </h4>
          <p className="text-card-text font-thin text-md md:text-xl">
            Simply refer a friend and get 10% discount on your next print, and a free print on
