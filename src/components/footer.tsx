...
const Footer = () => {
  return (
    <div className='flex flex-col bg-footer px-10 py-10 text-footer-text'>
      {/* top    */}
      <div className='flex items-start mb-10'>
        ...
        <div className='w-1/2 flex justify-between '>
          ...
          <div className='text-sm w-1/2 mb-10'>
        ...
        {/* info and menu */}
        <div className='flex justify-end space-x-9 w-1/2 text-sm'>
      ...
      {/* copyright info */}
      <div className='flex border-t-2 border-white justify-between'>
