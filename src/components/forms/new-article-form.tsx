      ...
      <form onSubmit={handleSubmit((data) => {
        ...
        <div className='w-full text-card-text font-bold'>
          ...
          <div className='w-full border-nav border-2 flex items-center pr-2 '>
            <input type='text' placeholder='Title' {...register("title", { required: "Title is required" })} className='p-2 w-full outline-none' />
        ...
        <div className='w-full text-card-text font-bold'>
          ...
          <div className='w-full border-nav border-2 flex items-center pr-2 '>
            <input type='text' placeholder='Subtitle' {...register("subtitle", { required: "subtitle is required" })} className='p-2 w-full outline-none' />
            <BsQuestionCircle size={25} />
          </div>
        ...
        <div className='w-full text-card-text font-bold'>
          ...
          <div className='w-full border-nav border-2 flex items-center pr-2 '>
            <input type='text' placeholder='Press enter to save tag' {...register("tag", { required: "tags are required" })} className='p-2 w-full outline-none' />
            <BsQuestionCircle size={25} />
          </div>
        ...
        <div className='w-full'>
          ...
          <Controller
            name="article"
            control={control}
            render={({ field }) => <SimpleMDE placeholder='Write your article' className='text-coral' {...field} />
            } />
